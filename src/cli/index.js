...
const program = sade('typedoc-pkg', true)
   ...
   .option('-a, --api-link', `Enable Typescript built-in library API linking; provide a colon separated string including 'es' and / or 'dom' / 'worker'.`)
   ...
   .option('-o, --output', `Provide a directory path for generated documentation.  (default docs)`)
   .option('-p, --path', `Path to a file(s) to use as entry points or specific 'package.json' to load. Multiple paths may be separated by colons.`)
